...
describe Aef::Week do
  ...
  context "#days" do
    it "should return a range of the weeks days" do
      described_class.new(2011, 15).days.should ==
        (Aef::WeekDay.new(2011, 15, 1)..Aef::WeekDay.new(2011, 15, 7))
    end
  end
  ...
  context "weekday methods" do
    ...
    it "should deliver monday" do
      @week.monday.should == Aef::WeekDay.new(@week, 1)
    end

    it "should deliver tuesday" do
      @week.tuesday.should == Aef::WeekDay.new(@week, 2)
    end

    it "should deliver wednesday" do
      @week.wednesday.should == Aef::WeekDay.new(@week, 3)
    end

    it "should deliver thursday" do
      @week.thursday.should == Aef::WeekDay.new(@week, 4)
    end

    it "should deliver friday" do
      @week.friday.should == Aef::WeekDay.new(@week, 5)
    end

    it "should deliver saturday" do
      @week.saturday.should == Aef::WeekDay.new(@week, 6)
    end

    it "should deliver sunday" do
      @week.sunday.should == Aef::WeekDay.new(@week, 7)
    end

    it "should deliver the weekend" do
      @week.weekend.should == [Aef::WeekDay.new(@week, 6), Aef::WeekDay.new(@week, 7)]
    end
  end
end